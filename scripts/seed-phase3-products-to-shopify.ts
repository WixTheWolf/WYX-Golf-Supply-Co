/**
 * seed-phase3-products-to-shopify.ts
 *
 * Seeds Phase 3 products to Shopify as ACTIVE listings.
 * Usage:
 *   npm run seed:phase3-products
 */

import { phase3Products } from '../lib/shopify/phase3Products';
...
async function main() {
  ...
  console.log(`\n🏌️  WYX Golf — Phase 3 Product Seed`);
  console.log(publish ? '🟢 Creating as ACTIVE' : '🟡 Creating as DRAFT');
  console.log(`📦 ${phase3Products.length} products\n`);

  const results: SeedResult[] = [];

  for (const product of phase3Products) {
