...
export const metadata: Metadata = { title: 'Contact | WYX Golf Supply Co.', description: 'Customer support information for WYX Golf Supply Co.', alternates: { canonical: '/contact' }, openGraph: { title: 'Contact | WYX Golf Supply Co.', description: 'Customer support information for WYX Golf Supply Co.', url: '/contact' } };
