...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="en" className={`${displayFont.variable} ${sansFont.variable}`}><body><SeoJsonLd /><TrackingScripts /><CartProvider><Header /><main>{children}</main><footer className="site-footer"><div><Link className="footer-brand" href="/">WYX <span>Golf Co.</span></Link><p>Golf gifts, trip kits, and bag gear with personality.</p><p className="footer-note">Use <strong>WYX10</strong> at checkout for 10% off your first order.</p><p className="footer-note">Support: <a href={`mailto:${supportEmail}`}>{supportEmail}</a></p></div><nav aria-label="Footer navigation"><Link href="/products">Shop</Link><Link href="/golf-gifts">Golf Gifts</Link><Link href="/golf-trip-gear">Trip Kits</Link><Link href="/scramble-prizes">Scramble Prizes</Link><Link href="/golf-gifts-under-60">Gifts Under $60</Link><Link href="/golf-gifts-for-dad">Dad Gifts</Link><Link href="/bachelor-party-golf-gifts">Bachelor Party Gifts</Link><Link href="/bag-upgrades">Bag Upgrades</Link><Link href="/the-roo">The Roo Waitlist</Link><Link href="/short-list">Short List</Link><Link href="/journal">Field Notes</Link><Link href="/faq">FAQ</Link><Link href="/shipping-returns">Shipping & Returns</Link><Link href="/contact">Contact</Link><Link href="/privacy">Privacy</Link></nav></footer></CartProvider></body></html>;
}
