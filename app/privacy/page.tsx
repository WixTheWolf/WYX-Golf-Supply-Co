...
export const metadata: Metadata = { title: 'Privacy', description: 'Privacy information for WYX Golf Supply Co.', alternates: { canonical: '/privacy' }, openGraph: { title: 'Privacy | WYX Golf Supply Co.', description: 'Privacy information for WYX Golf Supply Co.', url: '/privacy' } };
