...
const picks = [
  { label: 'Alignment Sticks 2-Pack', price: '$24', href: '/golf-training-aids', tag: 'Start Here', why: 'Two sticks — one for ball position, one for target line. Many beginners aim further off-target than they realize. Ten minutes of alignment stick work before a range session confirms aim before a single swing is taken.' },
  { label: 'Putting Mat — 9 Foot', price: '$48', href: '/golf-practice-gear', tag: 'Indoor Practice', why: 'A 9-foot indoor putting mat makes it easy to fit in short putting reps without driving to the course. A few minutes of daily home practice at 3-6 feet is a simple way to build more consistent short putts over time.' },
