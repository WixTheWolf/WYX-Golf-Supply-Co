...
export function KitAddButton({ lines, label, buyNowLabel = 'Buy Kit Now — WYX10 Applied', showBuyNow = false }: KitAddButtonProps) {
  ...
  return (
    <div className="kit-add">
      ...
      {validLines.length > 0 && <p className="selected-variant-note">{validLines.length} items · WYX10 auto-applied at checkout</p>}
